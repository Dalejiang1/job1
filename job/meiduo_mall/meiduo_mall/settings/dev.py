...
SECRET_KEY = '^qn(&pt734ay@er%$ix**xv1a)o_5fgfm0y8w-f8g-rdv4vw!x'
...
# 发送邮件的邮箱
EMAIL_HOST_USER = 'jiangb0521@163.com'
# 在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = 'TKOBSJJCSHTKHRCQ'
# 收件人看到的发件人
EMAIL_FROM = '美多商城激活验证码<jiangb0521@163.com>'
# 邮箱验证链接
